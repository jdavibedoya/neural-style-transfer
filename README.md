...
## 🖼️ Results
Content + Style = Generated Art
![Neural Style Transfer Process](images/example.png)


### 📝 Notes & Acknowledgments
* This project is heavily inspired by the *Art Generation with Neural Style Transfer* final lab from the **Convolutional Neural Networks** course by DeepLearning.AI.
* Please note that while the Markdown explanations in the notebook are in Spanish, the code is in English.
